...
The practical and theoretical interest in sorting, and the great relevance of cache memory and paralellism in modern computing naturally lead to research on sorting algorithms that take these factors into account.
chache sort simd \cite{DBLP:journals/pvldb/ChhuganiNLMHCBKD08,DBLP:journals/pvldb/InoueT15,DBLP:journals/pvldb/BalkesenATO13}.
