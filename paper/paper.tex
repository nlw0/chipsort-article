...
\caption{Empirical CDF from {\tt chipsort\_medium!} with 8k {\tt UInt32} values and {\tt chipsort\_large} with 256k values. Results from 10,000 measurements. Speedups are 14\% and 3\%.}
\label{fig:transpose-vecs}
\end{figure}
